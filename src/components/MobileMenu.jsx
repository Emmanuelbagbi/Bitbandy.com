  ...
  return (
    <div className="fixed inset-0" style={{ zIndex: 1200 }}>
      ...
      <div
        ...
        className="relative h-full flex flex-col bg-zinc-950"
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 pt-4 pb-3 shrink-0">
          ...
          <button
            ...
            className="w-11 h-11 flex items-center justify-center text-zinc-400 card-press"
            onClick={onClose}
          >
        ...
        <div className="mx-5 h-px bg-zinc-800 shrink-0" />
 
        {/* Navigation links */}
        <nav className="flex-1 px-5 pt-8 flex flex-col">
          <Link
            to="/"
            className="font-heading text-[34px] leading-[1.15] tracking-wide text-left py-2 text-zinc-100"
        ...
        >
          ...
          <Link
            to="/login"
            className="block w-full py-3 rounded-lg bg-zinc-800/60 border border-zinc-700/50 text-zinc-300 text-[13px] font-normal tracking-[0.02em] text-center card-press hover:text-zinc-100 transition-colors"
            onClick={onClose}
          >
            Sign in
          </Link>
        ...
        <div className="px-5 pb-10 shrink-0">
          ...
          <p className="text-[11px] text-zinc-700">© 2026 Bitbandy. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
